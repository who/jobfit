...
| CLI Design | High/Medium/Low | [Brief note on coverage] |
...
4. **Missing NFRs for Project Type**:
   - CLI projects should have usability and error handling NFRs
...
```
question: "Hi! I'm here to help you define requirements for '{{FEATURE_TITLE}}'. This is a cli project. Would you like to go through a full interview, or skip directly to one-shot PRD generation?"
header: "Mode"
options:
  - label: "Full interview (Recommended)"
    description: "Ask clarifying questions tailored to cli projects"
  - label: "One-shot PRD"
